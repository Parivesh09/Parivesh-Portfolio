...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Parivesh Rimjha",
          from_email: form.email,
          to_email: "pariveshrimjha20494@acropolis.in",
  ...
  return (
    <div
      className={`xl:mt-12 flex items-center justify-center xl:flex-row flex-col-reverse gap-10 overflow-hidden`}
    >
      <motion.div
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg 
			  outline-none border-none font-medium resize-none"
            />
          </label>
